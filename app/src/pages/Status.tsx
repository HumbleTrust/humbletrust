...
import { MAINNET_STATUS, NETWORK_STAGE, PROGRAM_ID, PROGRAM_ID_V2, RAYDIUM_CPMM_MAINNET_PROGRAM, RPC_DEVNET } from "../lib/constants";
  ...
  <>
    ...
    <section className="feat-bg status-section-tight">
      ...
      <div className="network-facts">
        ...
        <div><Lock size={16} /><span>v1 legacy devnet program</span><strong>{PROGRAM_ID}</strong></div>
