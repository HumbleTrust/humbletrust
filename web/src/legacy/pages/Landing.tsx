...
const HeroDashboard = () => (
  <div className="hero-market-card" aria-label="Live devnet market preview">
    <div className="hero-market-top">
      <div>
        <span>SAFE / SOL (DEVNET)</span>
        <strong>$0.000089</strong>
        <em>+18.3% 24h</em>
      </div>
      <div className="hero-safe-score">
        <strong>88</strong>
        <span>SAFE<br />TRUST</span>
      </div>
    </div>
      ...
      <svg viewBox="0 0 640 210" preserveAspectRatio="none" aria-hidden="true">
        <defs>
          <linearGradient id="heroChartFill" x1="0" x2="0" y1="0" y2="1">
            <stop offset="0%" stopColor="#00ff94" stopOpacity=".34" />
            <stop offset="100%" stopColor="#00ff94" stopOpacity="0" />
          </linearGradient>
        </defs>
        <path className="hero-chart-area" d="M0,124 C50,122 50,112 90,113 C145,114 158,104 205,106 C250,109 274,94 336,99 C386,103 410,98 465,101 C520,104 548,84 640,92 L640,210 L0,210 Z" />
        <path className="hero-chart-line" d="M0,124 C50,122 50,112 90,113 C145,114 158,104 205,106 C250,109 274,94 336,99 C386,103 410,98 465,101 C520,104 548,84 640,92" />
        <line x1="0" y1="72" x2="640" y2="72" />
        <line x1="0" y1="142" x2="640" y2="142" />
      </svg>
    </div>
    <div className="hero-market-foot">
      <span>Vol: $320K</span>
      <span><i /> LIVE</span>
      <span>Lock: 80% / 360d</span>
    </div>
  </div>
);

const LandingAlertStrip = () => (
  <div className="landing-alert-strip">
    <span>DEVNET ACTIVE - token launches, TrustScore, curve trading on Solana devnet only</span>
    <b>|</b>
    <span>MAINNET PREP - no real-value mainnet assets</span>
  </div>
);
    ...
    <section id="top" className="landing-hero">
      <div className="landing-hero-copy">
        <div className="landing-badge-row">
          <LandingBadge>Solana devnet - trust & safety layer</LandingBadge>
        </div>
        <h1 className="landing-h1">
          <span className="landing-h1-white">The Trust &</span>
          <span>Safety Layer</span>
          <span className="landing-h1-white">for Solana.</span>
        </h1>
        <p>
          Protected token launches. Military-grade PDA custody. Sybil-resistant
          TrustScore. The war room for serious on-chain builders.
        </p>
        <div className="hero-btns left">
          <button className="btn-p" onClick={goLaunch}>
            Launch Protected Token <ArrowRight size={16} />
          </button>
