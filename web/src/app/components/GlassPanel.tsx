...
export function GlassPanel({ children, className, hover = false, glow = "none", ...rest }: GlassPanelProps) {
  return (
    <div
      {...rest}
      className={cn(
        "rounded-lg backdrop-blur-xl bg-[rgba(20,20,30,0.5)] border border-[#1A2332]",
        "shadow-[0_8px_32px_rgba(0,0,0,0.3)]",
        hover && "transition-all duration-300 hover:border-[#1A2332]/80 hover:bg-[rgba(20,20,30,0.7)]",
